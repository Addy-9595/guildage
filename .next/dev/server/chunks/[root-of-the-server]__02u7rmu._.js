...
"[project]/Desktop/Guildage/pages/api/agents.js [api] (ecmascript)", ((__turbopack_context__, module, exports) => {

const { ensureReady } = __turbopack_context__.r("[project]/Desktop/Guildage/lib/db.js [api] (ecmascript)");
module.exports = async function handler(req, res) {
    if (req.method !== 'GET') return res.status(405).end();
    const db = await ensureReady();
    const result = await db.execute('SELECT * FROM agents WHERE deposit_paid = 1 ORDER BY token_balance DESC');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02u7rmu._.js.map